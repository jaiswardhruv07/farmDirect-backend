...
const getMyInventory = async (req, res, next) => {
  try {
    const inventory = await inventoryService.getMyInventory(req.user);
...
const getMyInventoryById = async (req, res, next) => {
  try {
    const inventory = await inventoryService.getMyInventoryById(
      req.user,
      req.params.id
    );
...
const updateMyInventory = async (req, res, next) => {
  try {
    const inventory = await inventoryService.updateMyInventory(
      req.user,
      req.params.id,
      req.body
    );
...
const adjustMyStock = async (req, res, next) => {
  try {
    const inventory = await inventoryService.adjustMyStock(
      req.user,
      req.params.id,
      req.body.operation,
      req.body.quantity
...
const adminCreateInventory = async (req, res, next) => {
  try {
    const inventory = await inventoryService.adminCreateInventory(
      req.user,
      req.body
    );
...
const getAdminInventory = async (req, res, next) => {
  try {
    const inventory = await inventoryService.getAdminInventory(
      req.user,
      req.query
    );
...
const getAdminInventoryById = async (req, res, next) => {
  try {
    const inventory = await inventoryService.getAdminInventoryById(
      req.user,
      req.params.id
    );
...
const adminAdjustStock = async (req, res, next) => {
  try {
    const inventory = await inventoryService.adminAdjustStock(
      req.user,
      req.params.id,
      req.body.operation,
      req.body.quantity
