...
const getMyProductById = async (req, res) => {
  try {
    const product =
      await productService.getMyProductById(
        req.user,
        req.params.id
      );
...
const updateMyProduct = async (req, res) => {
  try {
    const product =
      await productService.updateMyProduct(
        req.user,
        req.params.id,
        req.body
      );
...
const deleteMyProduct = async (req, res) => {
  try {
    await productService.deleteMyProduct(
      req.user,
      req.params.id
    );
...
const adminCreateProduct = async (req, res) => {
  try {
    const product =
      await productService.adminCreateProduct(
        req.user,
        req.body
      );
...
const adminUpdateProduct = async (req, res) => {
  try {
    const product =
      await productService.adminUpdateProduct(
        req.user,
        req.params.id,
        req.body
      );
...
const adminDeleteProduct = async (req, res) => {
  try {
    await productService.adminDeleteProduct(
      req.user,
      req.params.id
    );
...
const getPendingProducts = async (req, res) => {
  try {
    const products =
      await productService.getPendingProducts(
        req.user
      );
...
const approveProduct = async (req, res) => {
  try {
    const product =
      await productService.approveProduct(
        req.user,
        req.params.id
      );
...
const rejectProduct = async (req, res) => {
  try {
    const product =
      await productService.rejectProduct(
        req.user,
        req.params.id,
